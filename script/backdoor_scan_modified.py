...
def callback(result, format, output):
    ...
    if format == "stdout":
        ...
        for r in results:
            print("+---------------------------------------------------------------------------------------------------+")
            tools.tab_print("ImageName: " + r.image_ref,expandNum=90)
            tools.tab_print("Backdoor File Path: " + r.filepath,expandNum=90)
            tools.tab_print("Description: " + r.description,expandNum=90)
        print("+---------------------------------------------------------------------------------------------------+")
        print("# ================================================================================================= #")
